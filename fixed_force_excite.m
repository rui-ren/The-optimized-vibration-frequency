...
%No.4 第一边界条件条件
 ...
 gBco=[    1,               1,                 0
  ...
  gNF=[ For_Node,                         1,                                Force;
   ...
   f(For_Node,i)=gNF(2,3);
    else
        gNF=[ floor(Distance_For/p),                  1,        (p-mod(Distance_For, p)/p)*Force; 
                    floor(Distance_For/p)             2,                               0;
                    floor(Distance_For/p)+1           1,         (mod(Distance_For,p)/p)*Force;
                    floor(Distance_For/p)+1           2,                               0]; 
     f(For_Node,i)=gNF(1,3);
  ...
  gNF=[ For_Node,                         1,                            Force*sin(w*(i-1));
   ...
   f(For_Node,i)=gNF(2,3);
        ...
        gNF=[ floor(Distance_For/p),                  1,        (p-mod(Distance_For, p)/p)*Force*sin(w*(i-1)); 
                    floor(Distance_For/p)             2,                               0;
                    floor(Distance_For/p)+1           1,         (mod(Distance_For,p)/p)*Force*sin(w*(i-1));
                    floor(Distance_For/p)+1           2,                               0]; 
     f(For_Node,i)=gNF(1,3);
     f(For_Node+1,i)=gNF(2,3);
     f(For_Node+2,i)=gNF(3,3);
